...
namespace NetModuleParser.StructureElements.PeHeader
{
    ...
    {
        [PropertyDescription(24, 4, PeHeaderDescription.BaseOfData, typeof(UInt32DescriptionService))]
        ...
        [PropertyDescription(28, 4, PeHeaderDescription.ImageBase, typeof(UInt32DescriptionService))]
        ...
        [PropertyDescription(72, 4, PeHeaderDescription.SizeOfStackReserve, typeof(UInt32DescriptionService))]
        ...
        [PropertyDescription(76, 4, PeHeaderDescription.SizeOfStackCommit, typeof(UInt32DescriptionService))]
        public uint SizeOfStackCommit { get; set; } // The size of the stack to commit. 

        [PropertyDescription(80, 4, PeHeaderDescription.SizeOfHeapReserve, typeof(UInt32DescriptionService))]
        ...
        [PropertyDescription(84, 4, PeHeaderDescription.SizeOfHeapCommit, typeof(UInt32DescriptionService))]
        public uint SizeOfHeapCommit { get; set; } // The size of the local heap space to commit. 

        [PropertyDescription(88, 4, PeHeaderDescription.LoaderFlags, typeof(UInt32DescriptionService))]
        public uint LoaderFlags { get; set; } //Obsolete, set to 0

        [PropertyDescription(92, 4, PeHeaderDescription.NumberOfRvaAndSizes, typeof(UInt32DescriptionService))]
