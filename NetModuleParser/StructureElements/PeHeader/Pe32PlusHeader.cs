...
namespace NetModuleParser.StructureElements.PeHeader
{
    ...
    {
        [PropertyDescription(24, 8, PeHeaderDescription.ImageBase, typeof(UInt64DescriptionService))]
        ...
        [PropertyDescription(72, 8, PeHeaderDescription.SizeOfStackReserve, typeof(UInt64DescriptionService))]
        ...
        [PropertyDescription(80, 8, PeHeaderDescription.SizeOfStackCommit, typeof(UInt64DescriptionService))]
        public ulong SizeOfStackCommit { get; set; } // The size of the stack to commit. 

        [PropertyDescription(88, 8, PeHeaderDescription.SizeOfHeapReserve, typeof(UInt64DescriptionService))]
        ...
        [PropertyDescription(96, 8, PeHeaderDescription.SizeOfHeapCommit, typeof(UInt64DescriptionService))]
        public ulong SizeOfHeapCommit { get; set; } // The size of the local heap space to commit. 

        [PropertyDescription(104, 4, PeHeaderDescription.LoaderFlags, typeof(UInt32DescriptionService))]
        public uint LoaderFlags { get; set; } //Obsolete, set to 0

        [PropertyDescription(108, 4, PeHeaderDescription.NumberOfRvaAndSizes, typeof(UInt32DescriptionService))]
